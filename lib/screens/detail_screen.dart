...
class _DetailScreenState extends State<DetailScreen> {
  ...
  late Future<List<WebtooEpisodeModel>> episodes;
            ...
            children: [
              Row(
                ...
                children: [
                  Hero(
                      tag: widget.id,
                      child: GetWebtoonThumb(thumb: widget.thumb)),
                ],
              ),
...
class GetWebtoonThumb extends StatelessWidget {
  const GetWebtoonThumb({
    super.key,
    required this.thumb,
  });
